...
public class Closed extends javax.swing.JFrame {
    ...
    private void loadTableData() {
        ...
        try {
            ...
            String[] displayColumns = {"SaleOrderNo", "PurchaseOrderNo", "PurchaseOrderDate",
                "UserID", "CustomerName", "CustomerPhoneNo", "TotalAmount", "CompletedDate",
                "DeliveryDate", "DeliveryStatus", "OrderStatus"};
            ...
            while ((line = br.readLine()) != null) {
                ...
                Object[] rowData = {dataRow[0], dataRow[1], dataRow[2], dataRow[3],
                    dataRow[4], dataRow[5], dataRow[6], dataRow[8], dataRow[9], dataRow[10], dataRow[11]};
    ...
    private void generatePDF(List<Object[]> rowDataList) throws BadElementException, IOException {
        ...
        String defaultApproveReportFileName = "ClosedReport_" + dateTimeStr;
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                // Add "Closed Report" at the new line
                Paragraph closedReportParagraph = new Paragraph("Closed Report");
                closedReportParagraph.setAlignment(Element.ALIGN_CENTER); // Align "Closed Report" to the center
                document.add(closedReportParagraph);
                ...
                headerTable.setWidthPercentage(100); // Set table width to 100% of page width
                String[] columnNames = {"Salesperson ID", "Customer Name", "Sale Order No", "Purchase Order No", "Purchase Order Date", "Total Amount"};
                for (String columnName : columnNames) {
                    PdfPCell cell = new PdfPCell(new Phrase(columnName));
                    cell.setBorderWidth(1f); // Set border width for cells
                ...
                for (Object[] rowData : rowDataList) {
                    PdfPTable dataRowTable = new PdfPTable(6);
                    dataRowTable.setWidthPercentage(100); // Set table width to 100% of page width
                    for (Object cellData : rowData) {
                        PdfPCell cell = new PdfPCell(new Phrase(cellData != null ? cellData.toString() : ""));
                        cell.setBorderWidth(1f); // Set border width for cells
                        dataRowTable.addCell(cell);
                    }
    ...
    private void addComboBoxActionListener() {
        cbOrderStatus.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                filterTableByOrderStatus(); // Call method to filter table
            }
        });
    }
    ...
    // Method to filter table by OrderStatus
    private void filterTableByOrderStatus() {
        DefaultTableModel model = (DefaultTableModel) tbSaleOrdersTable.getModel();
        TableRowSorter<DefaultTableModel> sorter = new TableRowSorter<>(model);
        tbSaleOrdersTable.setRowSorter(sorter);
